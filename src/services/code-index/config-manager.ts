...
export class CodeIndexConfigManager {
	...
	private _loadAndSetConfiguration(): void {
		...
		const openAiKey = (this.contextProxy?.getSecret("codeIndexOpenAiKey") as string) || ""
		const qdrantApiKey = (this.contextProxy?.getSecret("codeIndexQdrantApiKey") as string) || ""
